...
def from_spotify_url(
    ...
    # contributing_artists = list(contributing_artists[0])
    # print(contributing_artists, contributing_artists[0])
    ...
    return SongObject(raw_track_meta, raw_album_meta, raw_artist_meta, youtube_link)
